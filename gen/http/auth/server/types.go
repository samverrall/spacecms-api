...
func NewGrantTokenResponseBody(res *auth.Token) *GrantTokenResponseBody {
...
// the result of the "CreateAccount" endpoint of the "auth" service.
...
// result of the "CreateAccount" endpoint of the "auth" service.
...
// result of the "GrantToken" endpoint of the "auth" service.
...
// NewCreateAccountUser builds a auth service CreateAccount endpoint payload.
func NewCreateAccountUser(body *CreateAccountRequestBody) *auth.User {
	v := &auth.User{
		ID:       body.ID,
		Email:    *body.Email,
		Name:     *body.Name,
...
// NewGrantTokenPayload builds a auth service GrantToken endpoint payload.
func NewGrantTokenPayload(body *GrantTokenRequestBody, token *string) *auth.GrantTokenPayload {
