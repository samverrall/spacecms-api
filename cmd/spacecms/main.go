...
import (
	...
	cmsapi "github.com/samverrall/spacecms-api/controllers/cms"
...
func main() {
	...
	{
		invoiceSvc = authapi.NewAuthService(logger, nil)
		cmsSvc = cmsapi.NewCMSService(logger, nil)
	}
	...
	)
	{
		...
		cmsEndpoints = cms.NewEndpoints(cmsSvc)
	}
	...
	case "localhost":
		{
			...
			handleHTTPServer(ctx, u, cmsEndpoints, invoiceEndpoints, &wg, errc, logger, *dbgF)
		}
